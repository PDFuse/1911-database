...
function normalizeSerial(value) { return String(value || "").trim().toUpperCase().replace(/[#,	
...
function getIndividualPageLink(input){var serial=normalizeSerial(input); if(individualRecordPages[serial]){return "<p><a href='"+escapeHtml(individualRecordPages[serial])+"?v=20260529b'>Open Individual Record →</a></p>";} if(typeof pistolRecords!=="undefined"&&pistolRecords[serial]){return "<p><a href='pistols/"+encodeURIComponent(serial)+".html?v=20260529b'>Open Individual Record →</a></p>";} return "";}
